...
#SBATCH -N  1
#SBATCH -n  4
#SBATCH --gres=gpu:2                      # Num Devices  X GPUs on each node you ask for
...
/opt/ohpc/pub/examples/NVIDIA_CUDA-10.0_Samples/bin/x86_64/linux/release/nbody  -benchmark  -numdevices=2  -numbodies=1024000
